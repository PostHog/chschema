...
- Registry: `795637471508.dkr.ecr.us-east-1.amazonaws.com/posthog/chschema`
...
```sh
# Print usage
docker run --rm 795637471508.dkr.ecr.us-east-1.amazonaws.com/posthog/chschema:latest -help
...
docker run --rm \
  ...
  -v "$PWD/dump:/dump" \
  795637471508.dkr.ecr.us-east-1.amazonaws.com/posthog/chschema:latest \
